...
TITLE_OVERRIDES = {
    ...
    "confidence matters leveraging multi view geometric priors for gs based reconstruction": "Gaussian Splatting",
    ...
    "omnimech all in one multimodal mechanical benchmark for 3d reconstruction": "Object, Human & 3D Generation",
    ...
    "sensor informed per point covariance for structured light 3d imaging": "Dense Depth, Surface & Mesh Reconstruction",
    ...
    "when does an extra view help adapting single view 3d reconstruction with extra imagery": "Object, Human & 3D Generation",
